...
config = get_config()
config["data_path"] = "/scratch/gpfs/awiteck/data/isne_2023_andcomposite.csv"
config["N"] = 3
config["d_model"] = 512
config["lr"] = 7.3e-5
...
letter_to_length = {
    "A": {"input_length": 12, "output_length": 12},
    "B": {"input_length": 24, "output_length": 12},
    "C": {"input_length": 24, "output_length": 24},
...
config["experiment_name"] = f"{args.letter}{args.number}_isne_2023"
...
df.loc[df["Region"] == "isne_2023", "Region"] = "isne"
...
print("Loading model")
model_filename = config["output_dir"] + args.letter + args.number + "_2024_03_03.pt"
