...
config = get_config()
config["data_path"] = "/scratch/gpfs/awiteck/data/banc2023andcomposite.csv"
config["N"] = 3
config["d_model"] = 512
config["lr"] = 7.3e-5
...
config["experiment_name"] = f"{args.letter}{args.number}_banc_2023"
...
df.loc[df["Region"] == "banc_2023", "Region"] = "banc"
